...
namespace WindowsFormsApplast_project
{
    public partial class Form5 : Form
    {
        ...
        private void NEXT_1_Click(object sender, EventArgs e)
        {
            this.Close();
            Form6 opennew = new Form6();
            opennew.Show();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            string color = first.Text;
            if (color == "red" || color == "light red" || color == "dark red" || color == "maroon")
            {
                MessageBox.Show("The color you have choosen shows energy, passion, action, ambition and determination. On the negative side it shows anger.", "RESULT");
            }
            ...
            else if (color == "yellow" || color == "light yellow" || color == "dark yellow" || color == "skin" || color == "mustard")
            {
